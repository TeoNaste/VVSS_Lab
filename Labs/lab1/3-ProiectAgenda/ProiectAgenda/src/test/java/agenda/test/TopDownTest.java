...
public class TopDownTest {
        ...
        public void TC1() {
            ...
            Activity activity = new Activity("act1", start, duration, contacts, "desc");
        ...
        public void raportValid() {
            ...
            Activity activity = new Activity("actv", start, duration, contacts, "desc5");
            Activity activity2 = new Activity("actv", duration, duration2, contacts, "desc6");
            assertTrue(repAct.addActivity(activity2));
            assertTrue(repAct.addActivity(activity));

            assertTrue(repAct.activitiesOnDate("actv", start).size() == 1);
            assertTrue(repAct.activitiesOnDate("actv", duration).size() == 2);
        }
        ...
        public void integrationABC(){
            try {
                ...
                Activity activity2 = new Activity("act1",start2,duration2,contacts,"desc");
                assertTrue(repAct.addActivity(activity));

                assertTrue(repAct.activitiesOnDate("act1",start2).size() == 1);
